...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    // suppressHydrationWarning: the inline theme script rewrites data-theme (and
    // the gate touches html style) before React hydrates — intended mismatch
    <html lang="en" className={`${geist.variable} h-full`} data-theme="light" suppressHydrationWarning>
